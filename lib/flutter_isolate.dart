...
class FlutterIsolate {
  ...
  bool get _isCurrentIsolate {
     if(_isolateId == null){
       return true;
         ...
         return _current!._isolateId == _isolateId;
    } else {
       return false;
    }
  }
  ...
  static void _isolateInitialize() {
    ...
    eventSubscription = _event.receiveBroadcastStream().listen((isolateId) {
      ...
      final sendPort =
          IsolateNameServer.lookupPortByName((_current != null && _current!._isolateId != null) ? _current!._isolateId! : "")!;
      final setupReceivePort = ReceivePort();
      IsolateNameServer.removePortNameMapping((_current != null && _current!._isolateId != null) ? _current!._isolateId! : "");
